...
18. **Задача** Дадени са естествените числа **m** и **n**. Да се състави програма, която намира и извежда стойността на произведението: **n**(**n**+1)(**n**+2)…**m**.

#

19. **Задача** Да се напише програма, която по дадено реално число **x** намира стойността на израза ( ...(((**x** + 122)**x** + 120)**x** + 118)**x** +... + 4)**x** + 2.
