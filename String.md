...
11. **Задача** Дадена е редица от n низа. Да се напише програма, която проверява дали редицата е монотонно намаляваща.

<br>

12. **Задача** Да се напише програма, която сортира във възходящ ред елементите на редица от низове, представляващи имена. Сортираната редица да изведе по 5 думи на ред.

<br>

13. **Задача**  Напишете програма, която въвежда цяло число и извежда двоичният (шeстнадесетичният) му запис.
