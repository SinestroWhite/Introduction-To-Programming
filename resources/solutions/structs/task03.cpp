...
/*
    Задача За учениците в един клас се съхранява следната информация: пълно име, успех от I срок, успех от II срок. Напишете програма, която въвежда информация за учениците и:
...
int main() {
	...
	for (int i = 0; i < all_students.size(); i++) {
		std::cout << "We have a student called " << all_students[i].name << " he has the following marks: ";
		for (int j = 0; j < semesters; j++) {
    ...
    std::cout << "These are the best students with average score " << highest_average << ":\n";
    for (int i = 0; i < names.size(); i++) {
        std::cout << names[i] << "\n";
    }
